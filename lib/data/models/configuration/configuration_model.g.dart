...
ConfigurationModel _$ConfigurationModelFromJson(
  Map<String, dynamic> json,
) => ConfigurationModel(
  images: ImagesConfigModel.fromJson(json['images'] as Map<String, dynamic>),
  changeKeys:
...
ImagesConfigModel _$ImagesConfigModelFromJson(
  Map<String, dynamic> json,
) => ImagesConfigModel(
