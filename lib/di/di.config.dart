...
import 'package:cineverse/features/movie/home/api/search_api.dart' as _i739;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i167.MyListCubit>(() => _i167.MyListCubit());
    ...
    gh.factory<_i739.SearchAPI>(() => _i739.SearchAPI(gh<_i361.Dio>()));
    ...
    gh.lazySingleton<_i518.SearchRepo>(
        () => _i518.SearchRepo(gh<_i739.SearchAPI>()));
